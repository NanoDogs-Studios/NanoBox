...
namespace HeathenEngineering.SteamAPI
{
    public class LobbyMember
    {
        ...
        public LobbyMetadata Metadata { get; }
        #endregion
        ...
        public string this[string metadataKey]
        {
            ...
            set
            {
                if (userData.id == SteamUser.GetSteamID())
                    SteamMatchmaking.SetLobbyMemberData(lobbyId, metadataKey, value);
                else
                    Debug.LogWarning("You cannot set the metadata field of another lobby member, this call will be ignored.");
            }
        }

        public LobbyMember(CSteamID lobbyId, CSteamID userId)
        {
        ...
        internal void HandleDataUpdate(LobbyDataUpdate_t param)
        {
